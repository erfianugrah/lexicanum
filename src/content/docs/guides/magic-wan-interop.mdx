...
Origin: {
  ...
  L4Svc: TCP/UDP Service
}

# HTTP path
Users.HTTP -> Cloudflare.Proxy: HTTPS
Cloudflare.Proxy -> Cloudflare.LB1
Cloudflare.LB1 -> MagicWAN.MW: private IP (default VNET)
MagicWAN.MW -> MagicWAN.Tunnel: nexthop
MagicWAN.Tunnel -> Origin.Router: GRE or IPsec
Origin.Router -> Origin.HTTPSvc

# TCP/UDP path
Users.L4 -> Cloudflare.Spectrum: TCP or UDP
Cloudflare.Spectrum -> Cloudflare.LB2: origin_dns
Cloudflare.LB2 -> MagicWAN.MW: private IP (default VNET)
MagicWAN.Tunnel -> Origin.Router
Origin.Router -> Origin.L4Svc
```
