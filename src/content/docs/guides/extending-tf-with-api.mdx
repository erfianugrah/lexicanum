...
description: If a Terraform provider has limitations or lacking features you can use the `hashicorp/http` provider to call the underlying APIs directly to work around this
author: "Erfi Anugrah"
category: workstations
featured: true
blurb: "Calling the underlying API directly when the provider falls short."
---
...
# 2. Declare the API token variable
