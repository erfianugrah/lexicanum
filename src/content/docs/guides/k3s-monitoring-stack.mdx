...
spec:
  ...
  routes:
    - kind: Rule
      match: Host(`logpush-k3s.example.com`)
      middlewares:
        - name: decompress
          namespace: monitoring
      services:
...
logpush_loki_dest = "https://logpush-k3s.example.com/loki/api/v1/raw?header_Content-Type=application%2Fjson&header_X-Logpush-Secret=${var.logpush_secret}"
