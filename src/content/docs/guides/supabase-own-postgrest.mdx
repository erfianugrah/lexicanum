...
The reproducible form is the supabase-lab [`security-lockdown`](https://github.com/erfianugrah/supabase-lab/tree/cca1b5e/experiments/security-lockdown) experiment: [`s04-self-hosted-postgrest.ts`](https://github.com/erfianugrah/supabase-lab/blob/cca1b5e/experiments/security-lockdown/tests/s04-self-hosted-postgrest.ts) (Data API off, container, IP filter), [`s05-rate-limit.ts`](https://github.com/erfianugrah/supabase-lab/blob/cca1b5e/experiments/security-lockdown/tests/s05-rate-limit.ts) (nginx burst), [`ratelimit.nginx.conf`](https://github.com/erfianugrah/supabase-lab/blob/cca1b5e/experiments/security-lockdown/ratelimit.nginx.conf), [`s06-postgrest-role.ts`](https://github.com/erfianugrah/supabase-lab/blob/cca1b5e/experiments/security-lockdown/tests/s06-postgrest-role.ts) (the connection-role check), [`s20-xff-trust-boundary.ts`](https://github.com/erfianugrah/supabase-lab/blob/cca1b5e/experiments/security-lockdown/tests/s20-xff-trust-boundary.ts) with [`edge.nginx.conf`](https://github.com/erfianugrah/supabase-lab/blob/cca1b5e/experiments/security-lockdown/edge.nginx.conf) (the through-edge header check), and the `postgrest-up` / `ratelimit-up` / `edge-up` Makefile targets. The 2026-09-03 artifacts are under [`out/2026-09-03/`](https://github.com/erfianugrah/supabase-lab/tree/cca1b5e/experiments/security-lockdown/out/2026-09-03).
