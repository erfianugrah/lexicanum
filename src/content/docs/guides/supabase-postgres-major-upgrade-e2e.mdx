...
corroborated by Supabase's own clone documentation.[^sb-clone]
...
| Using the clone as a source for another clone | n/a | not supported - a restored project cannot itself be cloned[^sb-clone] |
