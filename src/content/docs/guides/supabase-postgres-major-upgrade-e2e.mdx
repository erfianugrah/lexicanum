...
which shrinks the gap. It does not remove it. Any instant you choose is still an
instant, and a source that keeps taking writes has moved past it by the time the
new project is up.
