...
Internet -> WAN: DoT port 853
WAN -> Container: "DNAT rule 29 853→10.0.10.10:853"
LAN -> MagicWAN: "Hairpin via Magic WAN" {style.stroke-dash: 3}
MagicWAN -> Container: table 20 {style.stroke-dash: 3}
Container -> MagicWAN: "To Cloudflare IPs rule 1 → table 20"
Container -> WAN: "Catch-all rule 2 → main table"
```
...
Rule1 -> Rule2: No
Rule2 -> Main1: Matches
Rule2 -> Hairpin: If narrowed
Hairpin -> Table20B: Yes
Hairpin -> Rule100: No
Rule100 -> Main2
```
