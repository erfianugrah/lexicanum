...
- ~~**The routing layer.**~~ Measured 2026-08-04. The discovery endpoint carries a
  promotion with no re-authentication and nothing in the data path, and ref-hiding is
  a vanity subdomain rather than a proxy. The gateway is not needed.
