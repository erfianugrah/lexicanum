...
The reproducible form is the supabase-lab [`iap-lockdown`](https://github.com/erfianugrah/supabase-lab/tree/0998c69/experiments/iap-lockdown) experiment: [`l10-tpa-iap-issuer.ts`](https://github.com/erfianugrah/supabase-lab/blob/0998c69/experiments/iap-lockdown/tests/l10-tpa-iap-issuer.ts) (Cloudflare Access issuer, resolution, the anon/GoTrue denials) and [`l10e-labissuer-admit.ts`](https://github.com/erfianugrah/supabase-lab/blob/0998c69/experiments/iap-lockdown/tests/l10e-labissuer-admit.ts) (the self-minted ES256 issuer, JWKS served by an Edge Function, the admit proof).
