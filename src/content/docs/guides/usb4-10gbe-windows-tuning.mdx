...
description: Install, stabilize, and tune a bus-powered USB4/Thunderbolt 10GbE adapter (Alpine Ridge + Marvell AQC113) on Windows - kill RTD3 link flapping, fix the single-flow TX cap with jumbo frames and driver knobs, align L2/L3 MTU across the link, and catch config drift with an assertion script.
author: "Erfi Anugrah"
---
