...
flowchart TB
    ...
    Internet[Internet Clients]:::lan -->|DoT port 853| WAN[VyOS WAN<br/>pppoe0<br/>195.240.x.x]:::wan

    WAN -->|DNAT rule 29<br/>853→10.0.10.10:853| Container[Glory-Hole Container<br/>10.0.10.10:853<br/>pod-podman-2]:::svc

    LAN[LAN Hosts<br/>10.0.69.x<br/>10.0.71.x]:::lan -.->|Hairpin via<br/>Magic WAN| MagicWAN[Magic WAN<br/>IPsec vti0]:::mw
