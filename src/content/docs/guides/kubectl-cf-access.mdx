...
:::note
Cloudflare Access SaaS app doesn't have the `offline_access` scope so sessions will only last 5 minutes. You could potentially use Workers to add that in after the fact.
:::
