...
graph TB
    ...
    %% VyOS Router
    VyOS[VyOS Router<br/>203.0.113.42]:::vyos
    ...
    subgraph Networks[" Internal Networks "]
        ...
        TPI[TPI/k3s Network<br/>eth1.200: 10.0.0.0/24<br/>Turing Pi cluster]:::network
    ...
    subgraph K3S[" k3s Cluster (TPI Network) "]
        subgraph K3S_Nodes[" Nodes "]
            Rock1[rock1<br/>10.0.0.9<br/>Control Plane]:::k3s
            Rock2[rock2<br/>10.0.0.10<br/>Worker]:::k3s
            Rock3[rock3<br/>10.0.0.11<br/>Worker]:::k3s
            Rock4[rock4<br/>10.0.0.12<br/>Worker]:::k3s
        end

        subgraph K3S_Services[" Services "]
            Traefik[Traefik Ingress<br/>10.0.0.100<br/>MetalLB LoadBalancer]:::service
