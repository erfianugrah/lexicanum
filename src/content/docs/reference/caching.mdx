...
This pattern is used in media transformation architectures (e.g., video streaming) where large files are split into segments with a manifest tracking the chunk locations.
