...
description: Measured answers for running Qwen3.8-27B under an agentic loop harness - why MTP speculative decoding degrades within minutes of agentic churn, why the draftless ngram-mod fails the same way, what reasoning_effort=medium actually costs and buys, and which popular config advice from the release-week threads fails on contact with measurement
author: Erfi Anugrah
