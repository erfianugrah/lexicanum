...
[experiments/edge-function-limits](https://github.com/erfianugrah/supabase-lab/tree/6fb1c81/experiments/edge-function-limits),
...
| Image processing | Do not import `sharp`: it bundles, deploys and dies at invocation. Use Storage image transformations or a runtime that supports native threads. | EF06; [image transformations billing](/reference/supabase-image-transformations-billing/) |
...
[RUNLOG.md](https://github.com/erfianugrah/supabase-lab/blob/6fb1c81/experiments/edge-function-limits/RUNLOG.md),
and the redacted run artifacts with their measurement tables are published
under
[out/2026-09-02/](https://github.com/erfianugrah/supabase-lab/tree/6fb1c81/experiments/edge-function-limits/out/2026-09-02).
