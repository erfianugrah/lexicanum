...
Sending a logo to print surfaces three concerns that are easy to mix up - resolution, file format, and color space - and the fix is a two-command conversion, not a redesign. This is the reference for what a printer actually needs and how to produce it from a vector source you already have.
