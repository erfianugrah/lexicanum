...
```bash
# Video resize (Akamai param, 725MB source -> container-cached 38MB result)
curl -I "https://videos.erfi.io/big_buck_bunny_1080p.mov?imwidth=320"

# Video resize (232MB source -> binding/cdn-cgi)
curl -I "https://videos.erfi.io/erfi-135kg.mp4?imwidth=640"

# Frame thumbnail (PNG, 640x360)
curl -I "https://videos.erfi.io/big_buck_bunny_1080p.mov?mode=frame&time=30s&width=640&height=360&format=png"

# Audio extraction (auto m4a -> audio mode)
curl -I "https://videos.erfi.io/big_buck_bunny_1080p.mov?format=m4a&duration=30s"

# Derivative
curl -I "https://videos.erfi.io/erfi-135kg.mp4?derivative=tablet"

# Spritesheet
curl -I "https://videos.erfi.io/erfi-135kg.mp4?mode=spritesheet&width=800&height=600"

# Debug diagnostics (JSON)
curl -s "https://videos.erfi.io/erfi-135kg.mp4?derivative=tablet&debug=view" | jq .diagnostics

# Check R2 + edge cache status
curl -I "https://videos.erfi.io/erfi-135kg.mp4?imwidth=640"
...
# Container async (first request to uncached 725MB transform)
curl -I "https://videos.erfi.io/big_buck_bunny_1080p.mov?imwidth=480"
# -> 202 Processing (Retry-After: 30) or 200 video/mp4 (if already cached in R2)
```
...
<Card title="Frame (232MB source)" icon="picture">
  <img
    alt="Frame at 5s"
    src="https://videos.erfi.io/erfi-135kg.mp4?mode=frame&time=5s&width=640&height=360&fit=cover&format=png"
    loading="lazy"
    style="width:100%"
  />
  <small>PNG frame at 5s from 232MB source via binding</small>
</Card>

<Card title="Spritesheet" icon="grid">
  <img
    alt="Spritesheet"
    src="https://videos.erfi.io/erfi-135kg.mp4?mode=spritesheet&width=800&height=600"
    loading="lazy"
    style="width:100%"
  />
  <small>800x600 spritesheet from 232MB source</small>
</Card>

  <Card title="Audio (auto m4a)" icon="microphone">
    <audio controls src="https://videos.erfi.io/erfi-135kg.mp4?format=m4a&duration=30s" style="width:100%"></audio>
