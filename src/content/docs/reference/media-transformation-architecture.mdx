...
Route -> CdnCgi: Remote ≤256MB
Route -> Container: >256MB or fps/speed/etc
...
All examples use [Big Buck Bunny](https://peach.blender.org/) (725MB, 1080p, 9:56 duration) — a demanding source that exercises the full three-tier pipeline.

### Video resize

<CardGrid>
  <Card title="320px (container cached)" icon="video">
    <video controls width="100%" preload="metadata">
      <source src="https://videos.erfi.io/big_buck_bunny_1080p.mov?imwidth=320" type="video/mp4" />
    </video>
    <small>`?imwidth=320` — 725MB source → 38MB via FFmpeg container → R2 cache</small>
  </Card>

  <Card title="640x360 with cover fit" icon="video">
    <video controls width="100%" preload="metadata">
      <source src="https://videos.erfi.io/big_buck_bunny_1080p.mov?width=640&height=360&fit=cover" type="video/mp4" />
    </video>
    <small>`?width=640&height=360&fit=cover`</small>
  </Card>
</CardGrid>
...
<CardGrid>
  <Card title="PNG at 30s" icon="picture">
    <img
      alt="Frame at 30s"
      ...
      style="width:100%"
    />
    <small>`?mode=frame&time=30s&width=640&format=png`</small>
  </Card>

  <Card title="JPEG at 2m" icon="picture">
    <img
      alt="Frame at 2m"
      src="https://videos.erfi.io/big_buck_bunny_1080p.mov?mode=frame&time=2m&width=640&height=360&format=jpg"
      loading="lazy"
      style="width:100%"
    />
    <small>`?mode=frame&time=2m&width=640&format=jpg`</small>
  </Card>
</CardGrid>

### Spritesheet

<Card title="800x600 spritesheet" icon="grid">
  <img
    alt="Spritesheet"
    ...
    style="width:100%"
  />
  <small>`?mode=spritesheet&width=800&height=600`</small>
</Card>

### Audio

<CardGrid>
  <Card title="Audio extraction (30s)" icon="microphone">
    <audio controls src="https://videos.erfi.io/big_buck_bunny_1080p.mov?mode=audio&duration=30s" style="width:100%"></audio>
    <small>`?mode=audio&duration=30s`</small>
  </Card>

  <Card title="Auto m4a switch" icon="microphone">
    <audio controls src="https://videos.erfi.io/big_buck_bunny_1080p.mov?format=m4a&duration=60s" style="width:100%"></audio>
    <small>`?format=m4a&duration=60s` — auto-switches to audio mode</small>
  </Card>
</CardGrid>
...
<CardGrid>
  <Card title="Tablet (1280x720)" icon="video">
    <video controls width="100%" preload="metadata">
      <source src="https://videos.erfi.io/big_buck_bunny_1080p.mov?derivative=tablet" type="video/mp4" />
    </video>
    <small>`?derivative=tablet` (or `?impolicy=tablet`)</small>
  </Card>

  <Card title="Thumbnail (frame)" icon="picture">
    <img
      alt="Thumbnail"
      src="https://videos.erfi.io/big_buck_bunny_1080p.mov?derivative=thumbnail"
      loading="lazy"
      style="width:100%"
    />
    <small>`?derivative=thumbnail` — 640x360 PNG frame</small>
  </Card>
</CardGrid>
