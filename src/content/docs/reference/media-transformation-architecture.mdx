...
| 202 Processing | Container async (>100 MiB) or reactive 9402 | Return JSON with `Retry-After: 30` |
...
worker1 -> sizecheck
sizecheck -> container_do: yes
worker1 -> client1: immediate 202
container_do -> container: /transform-url
