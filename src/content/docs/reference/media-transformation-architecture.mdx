...
Coalesce -> Binding: R2 source <=100 MiB
Coalesce -> CdnCgi: remote <=100 MiB
...
Request -> Edge
Edge -> Return1: HIT (cf-cache-status: HIT, X-R2-Stored: HIT)
Edge -> R2: MISS
R2 -> CachePut: HIT (X-R2-Stored: HIT)
R2 -> Transform: MISS
