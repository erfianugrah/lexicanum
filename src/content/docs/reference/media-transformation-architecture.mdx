...
| Reactive error handling (9402 -> container) | Proactive size-based routing | HEAD check + size thresholds, no wasted transforms |
...
| 202 Processing | Container async (>256MB) | Return JSON with Retry-After, container processes in background |
