...
Measured claims map to module ids in the named supabase-lab experiments; every RUNLOG is public under [experiments/](https://github.com/erfianugrah/supabase-lab/tree/6fb1c81/experiments), and the self-hosted GoTrue runs have redacted artifacts with measurement tables under [self-hosted-auth/out/2026-09-02/](https://github.com/erfianugrah/supabase-lab/tree/6fb1c81/experiments/self-hosted-auth/out/2026-09-02).
