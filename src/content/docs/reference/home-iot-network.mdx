...
On mainline OpenWrt (since 2026-09-04) the access point's part is three UCI stanzas, kept in a git repo and pushed by a deploy script ([A bridged access point on mainline OpenWrt](/guides/openwrt-bridged-ap/) is the full build):
